...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="container pt-2 pb-4 bg-grey-1">
                ...
                <table class="table-1 mt-3">
                    <thead>
                        <tr>
                            <th colspan="2">
                                <div class="container row ">
                                    <div class="col-5 text-white">PAIN</div>
                                    <div class="col-2 text-white">X</div>
                                    <div class="col-5 text-white">SOLUTION</div>
                                </div>
                            </th>
                        </tr>
                    </thead>
...
I’ve encouraged him to start a blog. Besides showing passion about his career, he can learn more, spread his knowledge and engage with the coding community.  
        ...
        <section> sessão não feita </section>
        <h4 class="bordered-title">USER INTERVIEW</h4>
        <section class="container bg-grid pt-1 pb-4 mt-2 mx-none">
            <h2 class="text-blue-9 big-title argent-cf-bold text-center my-2">
                03 <br>
