...
<html lang="pt-br">
    <head>
        ...
        <title>School Car - Rafael Maciel</title>
    ...
    <body>
        ...
        <section class="container bg-white" style="padding-top: 189px; margin-bottom: 150px;">
            ...
            <div class="mb-2 col-8 text-center">
        ...
        <section class="container row space-evenly align-start">
            ...
            <div class="col-3">
                ...
                <p>User Research (Desk Research, Survey), Product Strategy, Personas, User Journey Map, Information Architecture, User Interface, Style Guide.</p>
            </div>
        </section>
        ...
        <section class="container row space-evenly align-start mt-3">
            <div class="col-3 ml-1 pt-2">
                ...
                <p>
                    This project was develped during UberHack, at my hometown, Rio de Janeiro. 
            ...
            <div class="col-6 mt-2 row">
                <img src="/rafael-maciel/assets/images/school-car/Grupo374.png" >
            </div>
        </section>
        ...
        <section class="container pt-2 pb-2">
            ...
            <div class="container width-1080 mt-2">
                ...
                <div class="col-10 mt-2">
                    Rio de Janeiro is the worst city for commuting, according to an Expert Market Consultant research. In a ranking of 74 big cities around the world, Rio is in the last position. Their citizens takes 90 minutes to go to work. It's almost 3 hours in traffic every day.
                    <br><br>
                    <b>The worse traffic times are:</b><br>
                    7–9h: going to work or taking kids to school;<br>
                    12–13h: getting kids from school;<br>
                    17–20h: arriving from work or school;<br>
                    <br><br>
                    At school hours, besides the increasing number of cars, the streets that are next to the schools gets a nightmare, with a lot of parents cars blocking up the traffic.
                    <br><br>
                    <span class='small-title'>https://www.expertmarket.com/focus/research/best-and-worst-cities-for-commuting</span>
                </div>
            </div>
        </section>
        ...
        <section class="container pt-2 pb-2">
            ...
            <div class="container pt-2">
                ...
                <div class="text-center py-1">
                    ...
                    <div class='normal-title text-blue-9 gilroy-bold '> 11 million passangers – R$ 734 million market </div><br>
                    <div class='small-title'>ANTT Data (Transport service business in Brazil)</div>
                </div>
        ...
        <section class="container pt-2 pb-2">
            ...
            <div class="col-6 normal-title text-blue-9 gilroy-bold">
                Can you imagine how many parents takes their kid to school, with 2 or more free seats in the car?
            </div>
            <img class='col-6 my-2' src="/rafael-maciel/assets/images/school-car/schoolcar_fatherandsoncar.png">
            <div class="col-6 normal-title text-blue-9 gilroy-bold">
                How might we offer a service for parents to take other children to school and get paid for it?
            </div>
        </section>
            ...
            <div class="container width-1080 row align-start">
                <div class="col-10">
                    <div class="grid gap-xl">
                        <div class="col-4">
                            <img src="/rafael-maciel/assets/images/school-car/schoolcar_grafico1.png">
                        </div>
                        <div class="col-4">
                            <img src="/rafael-maciel/assets/images/school-car/schoolcar_grafico1.png">
                        </div>
                    ...
                    <div class="grid gap-xl">
                        <div class="col-4 text-normal border-top-green">72% trust in other kids parents to take their kids to school.</div> 
                        <div class="col-4 text-normal border-top-green">75% trust in any parent from school, even if these parents kids doesn’t have any connection with their kids.</div> 
                        <div class="col-4 text-normal border-top-green">70% answered that a fair price for the "ride" would be the gasoline plus the driver service.</div> 
                        <div class="col-4 text-normal"></div> 
                        <div class="col-4 text-normal border-top-yellow">25% trust only if their kids are in the same class of the driver children.</div> 
            ...
            <div class="container width-1080 ">
                <div class="col-12">
                    <h2 class='medium-title text-blue-9'>
                        ...
                        <small class='text-grey-3 small-title block gilroy-regular'>
                            PARENT THAT NEEDS TRANSPORTATION SERVICE
                        </small>
                    </h2>
                </div>
                ...
                <div class="col-12 pt-1">                    
                    ...
                    <div class="container row gap-md align-stretch mt-14">
                        ...
                        <div class="col-3 bg-blue-9 text-white p-1">
                            I want to build trust with other parents from my kids school.
                        </div>
                        <div class="col-3 bg-blue-9 text-white p-1">
                            I must arrive at my work on time.
                        </div>
                        <div class="col-3 bg-blue-9 text-white p-1 position-relative">
                            <img class='img-top' style="margin-top: -259px;" src="/rafael-maciel/assets/images/school-car/schoolcar_persona1.png">
                ...
                <div class="col-12 pt-1">                    
                    ...
                    <p style="font-size: 14px;">
                        ...
                        <b style="font-size: 17px;" class='argent-cf-bold-italic ml-1'>“School parents usually speak together by WhatsApp groups”.</b>
                    </p>
                </div>
            ...
            <div class="container width-1080">
                <table class='table-1 mt-3'>
                    <thead>
                        <tr>
                            <th>STAGES</th>
                            <th class='col-3'>FIRST APP USE</th>
                            <th class='col-3'>HIRING DRIVERS</th>
                            <th class='col-3'>DURING THE RIDES</th>
                            <th class='col-3'>AFTER THE RIDE</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            <td>DOING</td>
                            <td>Checking the service price, <br>who are the drivers, if she <br>knows them from school.</td>
                            <td>Organizing the week schedule.</td>
                            <td>Checking if the kid arrived safe at school.</td>
                            <td>Confirming that his/her kid arrived at school and nothing happened.</td>
                        </tr>
                        <tr>
                            <td>THINKING</td>
                            <td>Will it be affordable? <br>Is this service worth?</td>
                            <td>Who are the driver?<br>What kids are already in the other seats?<br>Can I keep this schedule for the whole semester?</td>
                            <td>Will my kid arrive at school on time?<br>What's the drive route? Is there any dangerous street?</td>
                            <td>Was everything ok?</td>
                        </tr>
                        <tr>
                            <td>OPPORTUNITIES</td>
                            <td class='text-green'>Inform the pricing by month, when scheduling.</td>
                            <td class='text-green'>Insert a driver filter by affinity, considering his/her kids grade and other kids in the car.<br>Insert evaluation and comments section.</td>
                            <td class='text-green'>GPS location and route.<br>Be able to call the driver.</td>
                            <td class='text-green'>Notify parents when the kids arrived at school.</td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="container width-1080 ">
                ...
                <div class="col-12 pt-1">                    
                    ...
                    <div class="container row gap-md align-stretch mt-14">
                        ...
                        <div class="col-3 bg-blue-9 text-white p-1">
                            The gasoline is too expensive.
                        </div>
                        <div class="col-3 bg-blue-9 text-white p-1">
                            I want some social interaction for my kid.
                        </div>
                        <div class="col-3 bg-blue-9 text-white p-1 position-relative">
                            <img class='img-top' style="margin-top: -289px;" src="/rafael-maciel/assets/images/school-car/schoolcar_persona2.png">
            ...
            <div class="container width-1080">
                <table class='table-1 mt-3'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>THINKING</td>
                            <td>Looking for the profit and service conditions. </td>
                            <td>Inserting the dates that he's available for driving or confirming ride schedules.</td>
                            <td>Taking kids to school.</td>
                            <td>What's my month profit until today?</td>
                        </tr>
                        <tr>
                            <td>OPPORTUNITIES</td>
                            <td class='text-green'>Insert an example of a driver profit in the same school or similar. <br>Explain all the conditions.</td>
                            <td class='text-green'>Notificate the driver immediately to confirm or refuse ride schedules. <br>Keep the month profit visible.</td>
                            <td class='text-green'>Send alarm notifications to parents kids (15min left, 5min left).</td>
                            <td class='text-green'>Give opportunities to drivers to earn more money, like being well payed for driving in a day out of schedule, when other driver had issues.</td>
                        </tr>
                    </tbody>
                </table>
        ...
        <section class='container bg-grey-1 mx-1 pt-2 pb-4'>
            ...
            <div class="container width-1080 gap-xl row align-stretch space-center">
                ...
                <div class="col-3 bg-white p-1">
                    Increase product reach <br>(new cities).
                </div>
                <div class="col-3 bg-white p-1">
                    Passenger and driver retention.
                </div>
            </div>
        </section>
        ...
        <section class='container pt-1 pb-4 mt-2'>
            ...
            <div class="grid width-1080 gap-lg mt-2">
                ...
                <div class="col-4 bg-white elevated-2 p-1">
                    <img class='mb-1' src="/rafael-maciel/assets/images/school-car/schoolcar_storyboard2.png">                    
                    <b>2.</b> Felipe is now 5 and it’s time to start school. Unlike pre-school, the school schedule isn’t flexible and she won’t be able to take him to school everyday anymore.
                </div>
                <div class="col-4 bg-white elevated-2 p-1">
                    <img class='mb-1' src="/rafael-maciel/assets/images/school-car/schoolcar_storyboard3.png">                    
                    <b>3.</b> She start looking for school transportation services, but she wasn’t comfortable to hire an unknown person or service.
                </div>
                <div class="col-4 bg-white elevated-2 p-1">
                    <img class='mb-1' src="/rafael-maciel/assets/images/school-car/schoolcar_storyboard4.png">
                    <b>4.</b> She found out that other parents from the same school were offering school transportation service, with the help of an app called School Car.
                </div>
                <div class="col-4 bg-white elevated-2 p-1">
                    <img class='mb-1' src="/rafael-maciel/assets/images/school-car/schoolcar_storyboard5.png">
                    <b>5.</b> Maria downloaded the app and hired Rodrigo, a father of her kid classroom, that has a flexible work schedule and loved the opportunity of earning some extra money to take his daughter and other kids to school.
                </div>
                <div class="col-4 bg-white elevated-2 p-1">
                    <img class='mb-1' src="/rafael-maciel/assets/images/school-car/schoolcar_storyboard6.png">
                    <b>6.</b> Day after day many parents become drivers in schools all around Brazil. And besides giving opportunities of work for many parents, a sense of community and unity was growing, because of the increasing number of parents interacting with each other. 
                </div>
            </div>
        ...
        <section class="container bg-white mx-1 pt-3 pb-4">
            ...
            <div class="container pt-3 normal-title gilroy-bold text-blue-9">
                ...
                <small class='col-12 mb-1 mt-3'>Driver site map</small>
                <img src="/rafael-maciel/assets/images/school-car/schoolcar_driver_sitemap.png">
            </div>
        </section>
        ...
        <section class="container mt-4 pb-4">
            ...
            <div class='container align-start col-8 mt-4 pb-3'>
                ...
                <span class="small-title">
                    To answer all the parents concerns, they are able to select drivers by rating, comments, pricing and affinity, that is calculated considering the kids in the car (same class? hired this driver before? is a friend of the driver kid?)
                </span>
            </div>
            ...
            <img src="/rafael-maciel/assets/images/school-car/Grupo469.png">
            ...
            <div class='container align-start col-8 mt-4 pb-3'>
                ...
                <span class="small-title">
                    Drivers dashboard is their calendar. They can change their availability at any time in a very easy and intuitive way. 
            ...
            <div class='container align-start col-8 mt-4 pb-3'>
                ...
                <span class="small-title">
                    To avoid getting late at school, the driver screen has a gps map with a route that is calculated considering a comfortable time to pick up the kids and take them to school. With a single tap, drivers can call parents at anytime to report any issue.
                    After finishing the scheduled rides for the day, drivers can get more rides for extra money. They just need to select this option, and they will be called if other drivers had any problem and needs a substitute.
                </span>
            </div>
            <img src="/rafael-maciel/assets/images/school-car/Grupo469.png">
        ...
        <section class="container pt-1 mt-2">
            ...
            <div class="container row mt-2">
                ...
                <div class='col-6 text-center'>
                    ...
                    <img src="/rafael-maciel/assets/images/school-car/Grupo895.png" alt="">
                </div>
            </div>

            <h4 class="bordered-title mt-2">SCHEDULE</h4>
            <div class='mt-2'>
                <img src="/rafael-maciel/assets/images/school-car/Grupo885.png" alt="">
            </div>

            <h4 class="bordered-title mt-2">DURING THE RIDE</h4>
            <div class='mt-2'>
                <img src="/rafael-maciel/assets/images/school-car/Grupo886.png" alt="">
            </div>

            <h4 class="bordered-title mt-2">DRIVER VIEW SCREENS</h4>
            <div class='mt-2'>
                <img src="/rafael-maciel/assets/images/school-car/Grupo887.png" alt="">
            </div>
                ...
                <div class="col-3">
                    <nav class="style-guide">
                        ...
                        <ul class='gilroy-medium text-white pl-none mt-1'> 
                            ...
                            <img src="/rafael-maciel/assets/images/school-car/paleta.png">
                        </ul>

                        <header class='gilroy-bold mt-2 text-white'>TYPOGRAPHY</header>
                        
                        <ul class='gilroy-medium text-white pl-none mt-1'> 
                            <img src="/rafael-maciel/assets/images/school-car/schoolcar_sg_font.png">
                            <header class='gilroy-bold mt-2 mb-1 small-title text-white'>OTHER</header>
                            <img src="/rafael-maciel/assets/images/school-car/schoolcar_sg_brand.png">
                        </ul>
                    </nav>
                </div>
                <div class="col-3">
                    <nav class="style-guide">
                        ...
                        <ul class='gilroy-medium text-white pl-none mt-1'> 
                            ...
                            <img src="/rafael-maciel/assets/images/school-car/Retângulo17.png">
                        </ul>

                        <ul class='gilroy-medium pl-none mt-1'> 
                            <span class="small-title text-white">Navigation Items</span>
                            <img src="/rafael-maciel/assets/images/school-car/navItems.png">
                        </ul>
                ...
                <div class="col-3">
                    <nav class="style-guide">
                        <ul class='gilroy-medium pl-none'> 
                            <img src="/rafael-maciel/assets/images/school-car/icons.png">
                        </ul>
                    </nav>
                </div>
            </div>
