...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class='flex pt-4 pb-4 mt-2'> 
            ...
            <div class="flex container mt-3 handdle-scroll">            
                <div class="overflow-table-sm">
                    <div class="cnt-table">
                        <table class='table-1'>
                            <thead>
                                <tr>
                                    <th>STAGES</th>
                                    <th class='col-sm-3'>1. RECEIVING THE EMAIL WITH THE WEBSITE LINK</th>
                                    <th class='col-sm-3'>2. VISITING PLANTÃO DE VENDAS</th>
                                    <th class='col-sm-3'>3. PUTTING KNOWLEDGE INTO ACTION</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
